...
bool FacebookServiceProcessor::process(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot, void* callContext) {
...
bool FacebookServiceProcessor::process_fn(::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext) {
  std::map<std::string, void (FacebookServiceProcessor::*)(int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*, void*)>::iterator pfn;
...
void FacebookServiceProcessor::process_getName(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getName");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getName", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getName");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getName");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getName", bytes);
  }
}
...
void FacebookServiceProcessor::process_getVersion(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getVersion", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getVersion");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getVersion");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getVersion", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getVersion");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getVersion");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getVersion", bytes);
  }
}
...
void FacebookServiceProcessor::process_getStatus(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getStatus", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getStatus");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getStatus");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getStatus", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getStatus");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getStatus");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getStatus", bytes);
  }
}
...
void FacebookServiceProcessor::process_getStatusDetails(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getStatusDetails", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getStatusDetails");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getStatusDetails");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getStatusDetails", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getStatusDetails");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getStatusDetails");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getStatusDetails", bytes);
  }
}
...
void FacebookServiceProcessor::process_getCounters(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getCounters", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getCounters");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getCounters");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getCounters", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getCounters");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getCounters");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getCounters", bytes);
  }
}
...
void FacebookServiceProcessor::process_getCounter(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getCounter", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getCounter");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getCounter");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getCounter", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getCounter");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getCounter");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getCounter", bytes);
  }
}
...
void FacebookServiceProcessor::process_setOption(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.setOption", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.setOption");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.setOption");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.setOption", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.setOption");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.setOption");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.setOption", bytes);
  }
}
...
void FacebookServiceProcessor::process_getOption(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getOption", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getOption");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getOption");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getOption", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getOption");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getOption");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getOption", bytes);
  }
}
...
void FacebookServiceProcessor::process_getOptions(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getOptions", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getOptions");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getOptions");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getOptions", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getOptions");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getOptions");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getOptions", bytes);
  }
}
...
void FacebookServiceProcessor::process_getCpuProfile(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.getCpuProfile", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.getCpuProfile");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.getCpuProfile");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.getCpuProfile", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.getCpuProfile");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.getCpuProfile");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.getCpuProfile", bytes);
  }
}
...
void FacebookServiceProcessor::process_aliveSince(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.aliveSince", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.aliveSince");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.aliveSince");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.aliveSince", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.aliveSince");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "FacebookService.aliveSince");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "FacebookService.aliveSince", bytes);
  }
}
...
void FacebookServiceProcessor::process_reinitialize(int32_t, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol*, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.reinitialize", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.reinitialize");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.reinitialize");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.reinitialize", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.reinitialize");
    }
    return;
  }

  if (eventHandler_.get() != NULL) {
    eventHandler_->asyncComplete(ctx, "FacebookService.reinitialize");
  }
...
void FacebookServiceProcessor::process_shutdown(int32_t, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol*, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("FacebookService.shutdown", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "FacebookService.shutdown");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "FacebookService.shutdown");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "FacebookService.shutdown", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "FacebookService.shutdown");
    }
    return;
  }

  if (eventHandler_.get() != NULL) {
    eventHandler_->asyncComplete(ctx, "FacebookService.shutdown");
  }
