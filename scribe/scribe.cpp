...
void scribeProcessor::process_Log(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("scribe.Log", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "scribe.Log");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "scribe.Log");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "scribe.Log", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "scribe.Log");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "scribe.Log");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "scribe.Log", bytes);
  }
}
